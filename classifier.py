...
class BertSentClassifier(torch.nn.Module):
    def __init__(self, config):
        ...
        self.classification_head = torch.nn.Linear(self.bert.config.hidden_size, self.num_labels)
    ...
    def forward(self, input_ids, attention_mask):
        ...
        pooled_rep = output["pooler_output"]
        pooled_drop = self.dropout(pooled_rep)
        logits = self.classification_head(pooled_drop)
